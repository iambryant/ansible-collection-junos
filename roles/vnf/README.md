...
| `hardware_virtualization` | Boolean    | No       | Whether or not the VNF should use hardware_virtualization. Defaults to `false`.                                                                                                       |
...
| `no-autostart`            | Boolean    | No       | Whether or not the VNF should start after creation/on boot. Defaults to `false`.                                                                                                      |
